...
# Test...
# p = np.array([[3.53553e2, 3.39645e2, 2.77744e2, -1.44946e6], [-1.03528e2, 2.33212e1, 4.59607e2, -6.32525e5], [7.07107e-1, -3.53553e-1, 6.12372e-1, -9.18559e2]])
# K, R, C = decomposeCameraMtx(p)
# print(K)
# print(R)
# print(C)